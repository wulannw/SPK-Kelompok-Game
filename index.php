      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <form method="POST" action="">
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Pengembang Game</label>
              <div class="col-sm-5">
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th><i class="fa fa-arrow-down"></i> Nama Game</th>
                <th><i class="fa fa-arrow-down"></i> Pengembang Game</th>
                <th><i class="fa fa-arrow-down"></i> Kategori Game</th>
